        ...
        with db.begin():  # 트랜잭션 시작
            ...
            match_query = """
                INSERT INTO matches (dt, result, winning_point, losing_point, opposing_team, location,
                                     ...
                                     player_count, match_nature, team_a_name, team_b_name, include_in_records)
            ...
            for quarter_data in match_data.quarters:
                ...
                quarter_query = """
                    ...
                    VALUES (:match_idx, :quarter_number, :tactics, :team_b_tactics)
                ...
                quarter_values = {
                    ...
                    "team_b_tactics": quarter_data.team_b_tactics,
                }
            ...
            for quarter_data in match_data.quarters:
                ...
                for goal_data in quarter_data.goals:
                    goal_query = """
                        INSERT INTO goals (match_idx, quarter_idx, goal_player_id, assist_player_id, goal_type, scoring_team)
                        VALUES (:match_idx, :quarter_idx, :goal_player_id, :assist_player_id, :goal_type, :scoring_team);
                    """
                    goal_values = {
                        "match_idx": match_idx,
                        ...
                        "scoring_team": goal_data.scoring_team,
                    }
            ...
            for quarter_data in match_data.quarters:
                ...
                for lineup_data in quarter_data.lineups:
                    lineup_query = """
                        INSERT INTO quarters_lineup (player_idx, quarter_idx, position_idx, lineup_status, lineup_team)
                        VALUES (:player_idx, :quarter_idx, :position_idx, :lineup_status, :lineup_team);
                    """
                    lineup_values = {
                        ...
                        "lineup_team": lineup_data.lineup_team,
                    }
